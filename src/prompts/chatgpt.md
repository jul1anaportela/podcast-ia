...
Você é um roteirista de podcast, e vamos criar um  roteiro de um podcast de tecnologia, focado em frontend cujo o nome é "Código Estelar: A Ascensão do CSS" e tem foco em frontend,  com o público alvo de iniciantes em frontend
...
- no bloco [FINALIZAÇÃO] substitua por uma despedida cool com o final 'Eu sou a Ju e esse foi o Código Estelar dessa semana'
- use termos de fácil explicação
- O podcast vai ser apresentado somente por uma pessoa, chamada Ju
